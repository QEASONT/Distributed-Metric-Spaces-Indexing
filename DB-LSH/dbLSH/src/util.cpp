...
// -----------------------------------------------------------------------------
double calc_angle_normalized(				// calc angle
	int   dim,							// dimension
	const double *p1,					// 1st point
	const double *p2)					// 2nd point
{
	return acos(calc_inner_product(dim, p1, p2));
}

// -----------------------------------------------------------------------------
double calc_cosangle(				// calc cos(angle)
	int   dim,							// dimension
	const double *p1,					// 1st point
	const double *p2)					// 2nd point
{
...
// // -----------------------------------------------------------------------------
// double calc_l2_sqr(					// calc L2 square distance
// 	int   dim,							// dimension
// 	const double *p1,					// 1st point
// 	const double *p2)					// 2nd point
// {
