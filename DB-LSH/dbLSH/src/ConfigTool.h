...
public:
	...
	double GetConfigFloat(const char* config_key, const char *prefix=NULL);
	...
	int GetConfigFloatArray(const char* config_key, double *data_array, const char *prefix=NULL);
