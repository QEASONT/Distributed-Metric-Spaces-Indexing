...
int main(int argc, char const* argv[])
{
	...
	#else
		Config::highDataFilePath = "D:\\Code\\Metric_Space_Indexing\\PM-LSH-Formal\\dataset\\" + Config::dataSetName + ".data_all";
		Config::highQueryFilePath = "D:\\Code\\Metric_Space_Indexing\\PM-LSH-Formal\\dataset\\" + Config::dataSetName + ".data_all_query";
		Config::knnResultFilePath = "D:\\Code\\Metric_Space_Indexing\\PM-LSH-Formal\\dataset\\result\\" + Config::dataSetName + "_result_pmlsh.txt";
	#endif
